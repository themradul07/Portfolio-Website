...
export const PinContainer = ({
  ...
  const [transform, setTransform] = useState<string | null>(null); // Set initial state to null to avoid mismatches

  useEffect(() => {
    setTransform("translate(-50%,-50%) rotateX(0deg)"); // Set default transform on client side
  ...
  if (transform === null) {
    return null; // Return null until the component is mounted and the state is set on the client
  }
